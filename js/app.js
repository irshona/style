(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-body-fedback__slider")) new core(".slider-body-fedback__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 10,
            ...
            loop: true,
            pagination: {
                el: ".controls-header-body-fedback__dotts",
                clickable: true
            },
            breakpoints: {
                769: {
        ...
        if (document.querySelector(".slider-discounts__slider")) new core(".slider-discounts__slider", {
            ...
            pagination: {
                el: ".controls-slider-discounts__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".arrows-slider-discounts__prev",
                nextEl: ".arrows-slider-discounts__next"
            },
            on: {}
        });
    }
